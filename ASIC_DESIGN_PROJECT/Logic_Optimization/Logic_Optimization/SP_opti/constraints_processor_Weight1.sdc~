...
#group_path -name CLK -critical_range 1000.0 -to CLK
## GROUPING
# simple_processor_Top_Top (Run, Resetn, Clock,DIN,Bus,Done);
group_path  -name CLOCK -critical_range 1000.0 -from Clock -to clock -weight 5.0

group_path  -name INPUTS -through {Run, Resetn, DIN} -weight 50.0

group_path  -name OUTPUTS -to {Bus, Done} -weight 25.0
