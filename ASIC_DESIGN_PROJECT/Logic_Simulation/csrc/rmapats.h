...
extern "C" {
#endif
void  hs_0_M_0_0__output_file_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__output_file_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_0_2__output_file_daidir (UB  * pcode);
void  hs_0_M_1_0__output_file_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__output_file_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_1_2__output_file_daidir (UB  * pcode);
void  hs_0_M_2_0__output_file_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_1__output_file_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_2_2__output_file_daidir (UB  * pcode);
void  hs_0_M_5_0__output_file_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_0__output_file_daidir (UB  * pcode, scalar  val);
void  hs_0_M_6_1__output_file_daidir (UB  * pcode, scalar  val, U  I677, scalar  * I1303, U  did);
void  hs_0_M_6_2__output_file_daidir (UB  * pcode);
