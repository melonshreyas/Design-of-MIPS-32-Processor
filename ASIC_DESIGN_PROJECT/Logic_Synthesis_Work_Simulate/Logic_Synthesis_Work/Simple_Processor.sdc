...
# Created by write_sdc on Thu May  5 00:01:55 2022
...
set_wire_load_model -name 8000 -library saed14rvt_ss0p72v125c
set_max_transition 0.5 [current_design]
set_max_fanout 20 [current_design]
set_max_capacitance 100 [current_design]
set_load -pin_load 0 [get_ports {Bus[8]}]
set_load -pin_load 0 [get_ports {Bus[7]}]
set_load -pin_load 0 [get_ports {Bus[6]}]
set_load -pin_load 0 [get_ports {Bus[5]}]
set_load -pin_load 0 [get_ports {Bus[4]}]
set_load -pin_load 0 [get_ports {Bus[3]}]
set_load -pin_load 0 [get_ports {Bus[2]}]
set_load -pin_load 0 [get_ports {Bus[1]}]
set_load -pin_load 0 [get_ports {Bus[0]}]
set_load -pin_load 0 [get_ports Done]
