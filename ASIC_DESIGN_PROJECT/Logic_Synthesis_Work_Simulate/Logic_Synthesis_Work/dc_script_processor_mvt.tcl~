...
write -hierarchy -format verilog -output ./Simple_Processor_mvt_netlist.v
write_sdc ./Simple_Processor_Output_mvt.sdc
write_sdf ./Simple_Processor_Output_mvt.sdf
