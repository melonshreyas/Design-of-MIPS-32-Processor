...
# Created by write_sdc on Sun May  1 13:04:31 2022
...
set_wire_load_model -name 8000 -library saed14rvt_ff0p88v125c
set_max_transition 0.5 [current_design]
set_max_fanout 20 [current_design]
set_max_capacitance 100 [current_design]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports Run]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports Resetn]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[8]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[7]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[6]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[5]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[4]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[3]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[2]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[1]}]
set_driving_cell -lib_cell SAEDRVT14_BUF_10 -library saed14rvt_ff0p88v125c     \
-pin X [get_ports {DIN[0]}]
set_load -pin_load 12.83 [get_ports {Bus[8]}]
set_load -pin_load 12.83 [get_ports {Bus[7]}]
set_load -pin_load 12.83 [get_ports {Bus[6]}]
set_load -pin_load 12.83 [get_ports {Bus[5]}]
set_load -pin_load 12.83 [get_ports {Bus[4]}]
set_load -pin_load 12.83 [get_ports {Bus[3]}]
set_load -pin_load 12.83 [get_ports {Bus[2]}]
set_load -pin_load 12.83 [get_ports {Bus[1]}]
set_load -pin_load 12.83 [get_ports {Bus[0]}]
set_load -pin_load 12.83 [get_ports Done]
create_clock [get_ports Clock]  -name clock  -period 10  -waveform {0 5}
...
group_path -name INPUTS  -through [list [get_ports Run] [get_ports Resetn] [get_ports Clock]           \
