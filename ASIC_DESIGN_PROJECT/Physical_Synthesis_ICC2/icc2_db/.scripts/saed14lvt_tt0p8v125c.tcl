...
# workspace saed14lvt_tt0p8v125c:
create_workspace saed14lvt_tt0p8v125c
...
process_workspaces -check_options {-allow_missing} -force -output CLIBs/saed14lvt_tt0p8v125c.ndm
remove_workspace
